module top_packet_dispatcher #(
    ...
    parameter AXIS_USER_WIDTH = AXIS_PKT_LEN_WIDTH,
...
(
    ...
    input wire  [AXIS_USER_WIDTH-1:0]  	s_axis_top_packet_dispatcher_tuser,

    output wire  [AXIS_DATA_WIDTH-1:0] 	m_axis_top_packet_dispatcher_tdata,
    output wire  [AXIS_USER_WIDTH-1:0]  	m_axis_top_packet_dispatcher_tuser,
    ...
    assign m_axis_top_packet_dispatcher_tuser = w_pkt_len_metadata;
    //assign m_axis_top_packet_dispatcher_tdest = w_tcam_res_data;
